...
import Slider from "../componants/blog-slider-post/slider";
                                    ...
                                    <div className="col-12 mt-5">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <Link href="blog-standard-post" className="text-dark align-items-center">
                                                ...
                                                <Image src='/images/blog/6.jpg' width={65} height={44} className="avatar avatar-small rounded shadow ms-2" style={{height:"auto"}} alt=""/>
                                            </Link>
        
                                            <Link href="/" className="btn btn-lg btn-pills btn-icon btn-soft-primary"><FiHome className="icon"/></Link>
                                            
                                            <Link href="/blog-standard-post" className="text-dark align-items-center">
                                                <Image src='/images/blog/7.jpg' width={65} height={44} className="avatar avatar-small rounded shadow me-2" style={{height:"auto"}} alt=""/>
