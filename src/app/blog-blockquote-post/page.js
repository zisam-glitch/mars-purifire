                        ...
                        <div className="card blog  border-0 shadow rounded overflow-hidden">
                                <div className="bg-soft-primary p-4 rounded shadow">
                                    ...
                                    <div className="py-4 px-lg-4 my-2">
                                        <p className="text-dark fst-italic h5 mb-0 text-center">“ Im selfish, impatient and a little insecure. I make mistakes, I am out of control and at times hard to handle. But if you cant handle me at my worst, then you sure as hell dont deserve me at my best. ”</p>
                                    ...
                                    <div className="col-12 mt-5">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <Link href="blog-standard-post" className="text-dark align-items-center">
                                                ...
                                                <Image src='/images/blog/6.jpg' width={45} height={45} className="avatar avatar-small rounded shadow ms-2" style={{height:"auto"}} alt=""/>
                                            </Link>
        
                                            <Link href="/" className="btn btn-lg btn-pills btn-icon btn-soft-primary"><FiHome className="icon"/></Link>
                                            
                                            <Link href="/blog-standard-post" className="text-dark align-items-center">
                                                <Image src='/images/blog/7.jpg' width={45} height={45} className="avatar avatar-small rounded shadow me-2" style={{height:"auto"}} alt=""/>
