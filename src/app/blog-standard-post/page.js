                            ...
                            <div className="title-heading text-center">
                                ...
                                <ul className="list-inline text-center mb-0">
                                    ...
                                    <li className="list-inline-item mx-4 mt-4">
                                        ...
                                        <span className="text-white title-dark">13th Sep 2023</span>
                                    </li>
                ...
                <div className="row">
                    <div className="col-lg-8 col-md-7">
                        <div className="card border-0 shadow rounded overflow-hidden">
                            <Image src='/images/blog/blog.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid" alt=""/>
                                    ...
                                    <div className="col-12 mt-5">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <Link href="blog-standard-post" className="text-dark align-items-center">
                                                ...
                                                <Image src='/images/blog/6.jpg' width={65} height={48} className="avatar avatar-small rounded shadow ms-2" style={{height:"auto"}} alt=""/>
                                            </Link>
        
                                            <Link href="/" className="btn btn-lg btn-pills btn-icon btn-soft-primary"><FiHome className="icon"/></Link>
                                            
                                            <Link href="/blog-standard-post" className="text-dark align-items-center">
                                                <Image src='/images/blog/7.jpg' width={65} height={48} className="avatar avatar-small rounded shadow me-2" style={{height:"auto"}} alt=""/>
