                        ...
                        <div className="col-12">
                            <div className="title-heading text-center">
                                ...
                                <ul className="list-unstyled mt-2">
                                    <li className="list-inline-item text-muted small me-3"><FiMapPin className="text-white title-dark h6 me-1 mb-0"/> America - <span className="text-white title-dark">Full Time</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
