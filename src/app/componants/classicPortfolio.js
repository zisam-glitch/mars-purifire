                                ...
                                <div className="col picture-item" key={index}>
                                    <div className="card border-0 portfolio portfolio-primary portfolio-classic">
                                        <div className="card-body p-0">
                                            <Link href="#"  scroll={false} onClick={() => handleImageClick(item.id)}><Image src={item.image} width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded work-image" alt=""/></Link>
                                            <div className="pt-3">
